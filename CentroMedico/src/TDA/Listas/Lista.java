...
public interface Lista {
    ...
    public Nodo getNodo(int posicion) throws ListaException;// devuelve el elemento en laposicion indicada

    public Nodo getNodo(Object element) throws ListaException;// devuelve el nodo 
